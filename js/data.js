...
const DEFAULT_UNIVERSITY_INFO = {
  ...
  chancellor: "Dr. Abdul Azeez Khan",
...
const DEFAULT_FOUNDER = {
  ...
  image: "assets/images/founder_hemanathan.jpg",
  portrait: "assets/images/founder_hemanathan.jpg",
...
const DEFAULT_BOARD_MEMBERS = [
  {
    ...
    photo: "assets/images/founder_hemanathan.jpg",
  ...
  },
  {
    ...
    photo: "assets/images/board/abdul_azeez_khan.png",
    ...
    fullBio: "Dr. Abdul Azeez Khan brings extensive experience in higher education strategy, national regulatory compliance, and university accreditation. He guides the Senate in upholding high academic standards, institutional autonomy, and multidisciplinary excellence.",
  ...
  {
    id: "bm-3",
    name: "Dr. Javubar Sathick",
    position: "Vice Chancellor",
    department: "Executive Academic Administration",
    qualification: "Ph.D., M.Tech, Postdoc",
    experience: "24 Years in Higher Education & Research",
    email: "vc@hemanathan.edu.in",
    photo: "assets/images/board/javubar_sathick.png",
    bio: "Renowned academic administrator orchestrating academic programs, faculty development, and global research consortia.",
    fullBio: "Dr. Javubar Sathick is an internationally recognized expert in engineering innovation and higher education administration. Prior to joining HU, he served as Dean of Academics at premier institutes and led numerous government research initiatives in applied science and technology.",
    researchInterests: "Artificial Intelligence, Educational Systems, Engineering Research Methodologies",
    publications: "Over 80 peer-reviewed journal papers, 4 Patents, and 2 textbooks on Engineering Systems.",
    achievements: "Recipient of National Academic Leadership Award; Fellow of IEEE and National Academy of Sciences.",
    featured: true
  },
  {
    id: "bm-4",
    ...
    photo: "assets/images/board/hussain.png",
    ...
    fullBio: "Dr. Hussain oversees university regulatory compliance with UGC, AICTE, and NAAC. He directs academic admissions, student enrollment, statutory audits, and board secretariats with unwavering diligence.",
  ...
  },
  {
    ...
    photo: "assets/images/board/hemanth.png",
    bio: "Directs undergraduate and postgraduate curriculum modernization, continuous assessment, and accreditation benchmarks.",
    fullBio: "Dr. Hemanth leads HU's Academic Council, spearheading the implementation of NEP-aligned Choice-Based Credit Systems (CBCS), interdisciplinary minors, and international credit transfers.",
  ...
  },
  {
    ...
    qualification: "Ph.D., FCA, MBA (Finance), B.Com (Hons)",
    experience: "25 Years in Corporate & Institutional Finance",
    email: "finance.director@hemanathan.edu.in",
    photo: "assets/images/board/ashwin.png",
    bio: "Manages capital endowment, research grant treasury, infrastructure fiscal planning, and student scholarship portfolios.",
    fullBio: "Dr. Ashwin ensures institutional fiscal sustainability and transparency. He has overseen massive capital investments in modern labs, digital classrooms, and smart hostel infrastructures with meticulous prudence.",
  ...
  },
  {
    ...
    qualification: "Ph.D. (Materials Science & Engineering), Postdoc",
    experience: "19 Years in Deep-Tech Research & Technology Transfer",
    email: "research.director@hemanathan.edu.in",
    photo: "assets/images/board/harish.jpg",
    bio: "Spearheads sponsored research projects, patents, industry incubation, and doctoral fellowships across all departments.",
    fullBio: "Dr. Harish drives HU's innovation ecosystem, managing 12 specialized research centers and securing research grants exceeding ₹45 Crore from DST, SERB, and international funding agencies.",
    researchInterests: "Advanced Nanomaterials, Quantum Energy, Semiconductor Fabrication, Deep Tech Startups",
...
const DEFAULT_FACULTY_MEMBERS = [
  {
    id: "fac-1",
    name: "Dr. Rajinikanth",
    designation: "Professor & Chair Emeritus",
    department: "Computer Science",
    qualification: "Ph.D. (Honorary), D.Litt., F.I.E.T.",
    specialization: "Supercomputing, Autonomous Systems & Neural Robotics",
    experience: "30+ Years",
    email: "rajinikanth.superstar@hemanathan.edu.in",
    photo: "assets/images/faculty/rajinikanth.jpg",
    bio: "Global icon and chair of High-Performance Computing. Pioneering researcher in autonomous neural architectures, speed-of-light algorithmic execution, and human-machine coexistence.",
    fullBio: "Dr. Rajinikanth holds an honorary doctorate in Computational Sciences and has inspired pioneering research into multi-agent robotic swarms and high-velocity automation. He serves as Senior Faculty Advisor to the HU High Performance Computing Cluster and is renowned for delivering legendary motivational keynotes that electrify scholars and engineers worldwide.",
    researchInterests: "Advanced Robotics ('Chitti 2.0' Architectures), Kinetic Energy Recovery, Ultra-Parallel Computing, Fault-Tolerant Systems",
    publications: "Author of 'Infinite Velocity: Deterministic Computing at Scale'; 50+ keynote addresses at international scientific symposia.",
    achievements: "Padma Bhushan & Padma Vibhushan Laureate; Dadasaheb Phalke Honor; Lifetime Academic Patron Citation (2025).",
    featured: true
  },
  {
    id: "fac-2",
    name: "Dr. Chiyaan Vikram",
    designation: "Professor",
    department: "Computer Science",
    qualification: "Ph.D. (Cognitive Systems), M.Sc., B.A.",
    specialization: "Polymorphic Neural Networks, Cognitive AI & Biometrics",
    experience: "21 Years",
    email: "vikram.chiyaan@hemanathan.edu.in",
    photo: "assets/images/faculty/vikram.jpg",
    bio: "Master of chameleon-like adaptation and cognitive simulation. Directs the HU Neural Multi-Personality Modeling and Biometrics Lab.",
    fullBio: "Renowned for superhuman dedication and transformative discipline, Dr. Vikram investigates how neural network architectures can dynamically metamorphose across disparate task domains without catastrophic forgetting.",
    researchInterests: "Dynamic Neural Plasticity, Synthetic Voice Morphing, Deep Biometric Security, Extreme Physical & Algorithmic Transformation",
    publications: "28 high-impact publications on polymorphic AI; 2 patents in multi-modal facial expression synthesis.",
    achievements: "National Film Award Winner (Best Actor); Honorary Doctorate in Expressive Arts (University of Milan); HU Best Researcher Citation.",
    featured: true
  },
  {
    id: "fac-3",
    name: "Dr. Suriya Sivakumar",
    designation: "Professor & Head",
    department: "Computer Applications",
    qualification: "Ph.D., M.Tech (Software Systems), B.Com.",
    specialization: "Educational Technology, Cloud Computing & Social Innovation",
    experience: "18 Years",
    email: "suriya.sivakumar@hemanathan.edu.in",
    photo: "assets/images/faculty/suriya.jpg",
    bio: "Head of Computer Applications and Champion of Universal Digital Education. Directs digital empowerment platforms for rural learners.",
    fullBio: "Dr. Suriya Sivakumar combines deep technical expertise with philanthropic educational activism. Through his transformative research in scalable learning management architectures, he has helped digitize education for over 500,000 underprivileged students across rural India.",
    researchInterests: "EdTech Platforms, Low-Bandwidth Cloud Architectures, Human-Centered Software Design, AI for Social Good",
    publications: "35 papers in IEEE & ACM conferences on Educational Computing; Author of 'Bridging the Rural Digital Divide'.",
    achievements: "National Film Awardee (Best Feature & Actor); Founder Patron of Agaram Universal Educational Foundation; Global Humanitarian Citation.",
    featured: true
  },
  {
    id: "fac-4",
    name: "Dr. Sivakarthikeyan",
    designation: "Associate Professor",
    department: "Computer Applications",
    qualification: "Ph.D., M.E. (Software Systems), B.Tech (ECE)",
    specialization: "Interactive Media, Gamification Pedagogy & Human-Centered UX",
    experience: "12 Years",
    email: "sivakarthikeyan@hemanathan.edu.in",
    photo: "assets/images/faculty/sivakarthikeyan.jpg",
    bio: "Pioneering educator blending engineering rigor with charismatic media presentation. Directs the HU Media Computing & UX Lab.",
    fullBio: "Holding an engineering degree in Electronics and Communication, Dr. Sivakarthikeyan rose from collegiate mimicry champion to top box-office titan and university researcher. He teaches students how to engineer viral, high-engagement digital applications and interactive storytelling engines.",
    researchInterests: "Gamified Educational UX, Mobile App Engagement Algorithms, Viral Digital Media, Speech Synthesis",
    publications: "16 papers in IEEE Consumer Electronics; Co-author of 'Engineering Entertainment: Media Systems for Tomorrow'.",
    achievements: "SIIMA Best Actor Laureate; Youth Media Pioneer of the Decade; Tamil Nadu State Film Awardee.",
    featured: false
  },
  {
    id: "fac-5",
    ...
    qualification: "Ph.D., MBA (Leadership & Public Policy), B.Com.",
    specialization: "Transformational Leadership, Youth Governance & Mass Communication",
    experience: "22 Years",
    email: "vijay.thalapathy@hemanathan.edu.in",
    photo: "assets/images/faculty/vijay.jpg",
    bio: "Head of the Department of Management. Expert in motivational leadership, grassroots youth empowerment, and mass organizational mobilization.",
    fullBio: "Dr. Joseph Vijay combines charismatic transformational leadership with systematic public administration frameworks. His flagship course 'Mass Motivation & Strategic Leadership' is one of the most sought-after MBA electives at Hemanathan University.",
    researchInterests: "Youth Civic Engagement, Charismatic Leadership Dynamics, Crisis Management in Public Administration, Social Welfare Policy Models",
    publications: "30+ research papers on organizational loyalty, civic leadership, and youth development; Keynote speaker at Global Leadership Summits.",
    achievements: "National Youth Icon Citation; Founder of University Youth Mentorship Initiative; Kalaimamani Honor.",
    featured: true
  },
  {
    id: "fac-6",
    name: "Dr. Nayanthara Kurian",
    designation: "Professor & Dean",
    department: "Management",
    qualification: "Ph.D. (Business Leadership), MBA, B.A.",
    specialization: "Strategic Brand Architecture, Film Production Economics & Venture Building",
    experience: "19 Years",
    email: "nayanthara.k@hemanathan.edu.in",
    photo: "assets/images/faculty/nayanthara.jpg",
    bio: "Widely celebrated as the 'Lady Superstar'. Dean of the School of Management, pioneering women-led entrepreneurship and high-stakes media venture capital.",
    fullBio: "Dr. Nayanthara is an iconic trailblazer in Indian entertainment and entrepreneurship. As co-founder of Rowdy Pictures, The Lip Balm Company, and Chai Wale, she brings multimillion-dollar brand-building acumen directly to HU MBA scholars.",
    researchInterests: "Female Enterprise Leadership, Entertainment Venture Capital, Luxury Brand Architecture, Sovereign Consumer Behavior",
    publications: "Author of 'Unapologetic Excellence: Blueprint for Enterprise Leadership'; Over 20 keynote lectures at Women Global Business Forums.",
    achievements: "Filmfare Best Actress (Multiple Wins); Forbes India 100 Celebrity; Woman Entrepreneur of the Year.",
    featured: true
  },
  {
    id: "fac-7",
    ...
    designation: "Professor & Head",
    department: "Physics",
    qualification: "Ph.D. (Aerodynamics & Propulsion), M.Tech, Pilot Licensee",
    specialization: "Aerodynamics, Unmanned Aerial Systems & Precision Mechanics",
    experience: "20 Years",
    email: "ajith.kumar@hemanathan.edu.in",
    photo: "assets/images/faculty/ajith_kumar.jpg",
    bio: "Head of Department of Physics and Chief Technical Mentor for the HU Unmanned Aerial Vehicle (UAV) & High-Speed Aerodynamics Research Lab.",
    fullBio: "Dr. Ajith Kumar is a certified racing pilot and aerospace innovator. He spearheaded the design and flight-testing of next-generation autonomous UAVs for medical emergency delivery and search-and-rescue operations across Tamil Nadu.",
    researchInterests: "Fluid Dynamics, High-Velocity Aerodynamics, UAV Autonomous Avionics, Precision Riflery Mechanics, Electric Propulsion",
    publications: "25 papers in aerospace engineering and applied fluid mechanics; Principal Investigator for State Disaster Management UAV Consortium.",
    achievements: "Chief Technical Advisor to National UAV Research Programs; International Formula Racing Veteran; Exemplary Engineering Mentorship Award.",
    featured: true
  },
  {
    id: "fac-8",
    ...
    qualification: "Ph.D. (Game Theory & Non-Zero-Sum Systems), M.Sc., D.Litt.",
    specialization: "Algorithmic Game Theory, Resilience Dynamics & Mathematical Logic",
    experience: "26 Years",
    email: "vadivelu.legend@hemanathan.edu.in",
    photo: "assets/images/faculty/vadivelu.jpg",
    bio: "The uncontested 'Vaigai Puyal' of academia. Head of Mathematics, renowned for using situational wit to solve the most complex combinatorial problems.",
    fullBio: "Dr. Vadivelu is an intellectual force of nature. His legendary theory of 'Endurance Through Adversity' (popularized in his axiom 'Evvalavu Adichalum Thaanguran, Rombavum Nallavan') has been reformulated into an internationally recognized mathematical model on fault tolerance and stress recovery in distributed networks.",
    researchInterests: "Combinatorial Optimization, Asymmetric Warfare in Game Theory, Resilience Under Extreme Stress, Cognitive Humor in Algorithmic Proofs",
    publications: "40+ papers including the seminal work 'Building Strong Foundations: Why Even When It Falls, The Root Never Quivers'; Honorary Doctorate.",
    achievements: "Tamil Nadu State Film Award (Multiple Wins); Lifetime Cultural Icon Laureate; Honorary D.Litt.",
    featured: true
  },
  {
    id: "fac-9",
    name: "Dr. Vijay Sethupathi",
    designation: "Professor & Head",
    department: "Commerce",
    qualification: "Ph.D. (Development Economics), M.Com., B.Com.",
    specialization: "Grassroots Microfinance, Cooperative Economics & Rural Markets",
    experience: "16 Years",
    email: "vijay.sethupathi@hemanathan.edu.in",
    photo: "assets/images/faculty/vijay_sethupathi.jpg",
    bio: "Known fondly as 'Makkal Selvan'. Head of Department of Commerce, beloved for his down-to-earth, intuitive pedagogy and grassroots economic models.",
    fullBio: "Dr. Vijay Sethupathi brings organic wisdom and grounded commercial realism to university classrooms. Having worked in accountancy in Dubai before his meteoric rise, his research focuses on informal agricultural supply chains and decentralized community savings networks.",
    researchInterests: "Informal Financial Systems, Community Microcredit, Small Vendor Economic Resilience, Behavioral Commerce",
    publications: "Author of 'Everyday Economics: The Street Vendor's Blueprint'; 22 articles in Asian Journal of Development Studies.",
    achievements: "National Film Award Winner; State Kalaimamani Honor; Peoples' Academic Icon Citation (2024).",
    featured: true
  },
  {
    id: "fac-10",
    ...
    designation: "Professor",
    department: "Commerce",
    qualification: "Ph.D. (International Political Economy), M.Com., B.Sc.",
    specialization: "Cross-Border Trade Treaties, Negotiations & Sustainable Agriculture",
    experience: "25 Years",
    email: "prakash.raj@hemanathan.edu.in",
    photo: "assets/images/faculty/prakash_raj.jpg",
    bio: "Five-time National Award-winning versatile polyglot scholar. Teaches high-stakes international trade negotiations, agrarian economics, and multilingual commerce.",
    fullBio: "Fluent in Tamil, Telugu, Kannada, Malayalam, Hindi, and English, Dr. Prakash Raj brings global political-economic realism into commerce lecture halls. He is an active advocate for organic farming and village community micro-enterprises.",
    researchInterests: "Multi-Lateral Trade Negotiations, Agrarian Supply-Chain Sovereignty, Corporate Social Accountability, Behavioral Game Negotiations",
    publications: "30+ research papers on agricultural economics and international commercial law; Author of 'The Art of Confrontation and Consensus'.",
    achievements: "Five-Time National Film Award Winner; Dr. K.S. Narasimhaswamy Award; Founder of Justh Foundation for Rural Transformation.",
    featured: false
  },
  {
    id: "fac-11",
    ...
    designation: "Professor & Head",
    department: "English",
    qualification: "Ph.D. (Comparative Aesthetics), Chevalier dans l'Ordre des Arts et des Lettres, D.Litt.",
    specialization: "Polymorphic Dramatic Literature, Semiotics & Cultural Rhetoric",
    experience: "28 Years",
    email: "kamal.haasan@hemanathan.edu.in",
    photo: "assets/images/faculty/kamal_haasan.jpg",
    bio: "Polymath scholar and Head of the Department of English. World-renowned authority on multi-character narrative structures, polyglot linguistics, and experimental theatre pedagogy.",
    fullBio: "Dr. Kamal Haasan brings unparalleled multidisciplinary mastery spanning classical dramatic literature, existential philosophy, and cinematic narrative techniques. His seminars on polymorphic character development and linguistic nuances are attended by scholars from universities worldwide.",
    researchInterests: "Semiotics in Post-Modern Media, Comparative World Dramatic Literature, Classical Dravidian & Western Rhetoric, Screenwriting Morphology",
    publications: "Author of 'The Tenfold Perspective: Essays in Polymorphic Narrative'; Over 40 monograph essays on world literature and performance aesthetics.",
    achievements: "Chevalier of the French Republic; Padma Bhushan Laureate; President's Gold Medal for Excellence in Performing Arts.",
    featured: true
  },
  {
    id: "fac-12",
    name: "Dr. Dhanush K. Raja",
    designation: "Associate Professor",
    department: "English",
    qualification: "Ph.D., M.A. (English & Creative Writing), National Awardee",
    specialization: "Modern Lyricism, Global Folk Narratives & Screenplay Studies",
    experience: "15 Years",
    email: "dhanush.raja@hemanathan.edu.in",
    photo: "assets/images/faculty/dhanush.jpg",
    bio: "International literary and cinematic artist. Bridges grassroots Tamil folk ethos with global Hollywood & Bollywood storytelling paradigms.",
    fullBio: "Dr. Dhanush is a multi-talented lyricist, playwright, and scholar whose works have resonated from local villages to Hollywood red carpets. At Hemanathan University, he conducts masterclasses on cross-cultural narrative writing and modern lyrical composition.",
    researchInterests: "Subaltern Cultural Discourse, Contemporary Tamil Poetics, Cross-Cultural Screenplay Tropes, Global Viral Songwriting",
    publications: "Author of 3 collections of contemporary verse; 18 peer-reviewed articles on folk rhythms and narrative minimalism.",
    achievements: "Four-Time National Film Award Winner; Filmfare Laureate; Forbes India Celebrity 100 Honoree.",
    featured: false
  },
  {
    id: "fac-13",
    ...
    designation: "Associate Professor",
    department: "English",
    qualification: "Ph.D. (Classical Rhetoric), M.A. (English), BBA",
    specialization: "Historical Discourse, Royal Heritage Epics & Public Relations",
    experience: "17 Years",
    email: "trisha.krishnan@hemanathan.edu.in",
    photo: "assets/images/faculty/trisha.jpg",
    bio: "Eminent scholar of classical historical discourse, having portrayed iconic imperial figures such as Princess Kundavai. Expert in literary diplomacy and public relations.",
    fullBio: "Dr. Trisha Krishnan combines deep passion for classical historical epics with contemporary corporate PR and diplomatic communications. Her seminars on historical subtext in Kalki Krishnamurthy's literature draw full-house attendance.",
    researchInterests: "Chola Dynasty Narrative Heritage, Gender Roles in Classical Tamil Epics, International Brand Representation, Crisis Public Relations",
    publications: "20 papers in historical linguistics and literature; Contributing editor to 'Heritage Rhetoric of South India'.",
    achievements: "UNICEF Celebrity Advocate for Child Rights; Filmfare South Best Actress (Multiple Wins); Kalaimamani Honor.",
    featured: false
  }
];
  ...
  getBoardMembers: function() {
    try {
      ...
      if (stored) {
        ...
        const hasOld = list.some(m => m.name === 'Dr. Priya Sharma' || m.name === 'Dr. Meena Devi' || m.name === 'Mr. Suresh Kumar' || m.name === 'Dr. Karthik Raman' || (m.name === 'Dr. Hemanathan' && m.position === 'Chancellor') || m.photo === 'assets/images/university_crest.jpg');
        if (!hasOld) {
          return list;
        }
      }
    ...
    try {
      localStorage.setItem(STORAGE_KEYS.BOARD, JSON.stringify(DEFAULT_BOARD_MEMBERS));
    } catch (e) {}
